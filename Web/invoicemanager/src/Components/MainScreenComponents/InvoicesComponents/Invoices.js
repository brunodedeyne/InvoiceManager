...
class Invoices extends Component {
  ...
  printOverview = () => {
    ...
    doc.text(12, 37, "Overzicht " + (this.state.kwartaal ? "Kwartaal" : "") + (this.state.kwartaal ? this.state.kwartaal : "Jaar") + " - " + (this.state.paid == 5 || this.state.paid == "" ? "Alles" : (this.state.paid == 0 ? "Onbetaald" : "Betaald")));
