...
class Invoices extends Component {
  ...
  printOverview = () => {
    ...
    doc.setFontSize(14);
    if (this.state.kwartaal == "") tempKwartaal = "Alles";
    doc.text(12, 37, "Overzicht " + this.state.jaar + " "  + (this.state.kwartaal ? "Kwartaal" : "") + (this.state.kwartaal ? this.state.kwartaal : "Jaar") + " - " + (this.state.paid == 5 || this.state.paid == "" ? "Alles" : (this.state.paid == 0 ? "Onbetaald" : "Betaald")));
